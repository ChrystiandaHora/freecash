...
import { updateContaPagar } from '../services/financeiro'
...
export default function ContaPagarEditModal({ conta, onClose, onSaved, onError }) {
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end gap-3 border-t border-border/60 pt-4">
          ...
          <Button
            type="submit"
            disabled={updateMutation.isPending || isFaturaCartao}
