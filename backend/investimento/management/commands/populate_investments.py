"""Comando Customizado do Django para População de Classes de Investimento.

Permite povoar retroativamente a estrutura de classes, categorias e subcategorias padrões
de ativos B3 para todos os usuários existentes na base de dados.
"""
