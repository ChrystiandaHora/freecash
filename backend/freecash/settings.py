...
# Tenta carregar o arquivo .env da pasta BASE_DIR (backend/) ou da pasta pai (raiz)
...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-CHANGE-ME-local-dev-only")
