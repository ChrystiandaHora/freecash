...
`EmailOuUsernameBackend` decide todo login do produto. Verifica três propriedades:
o e-mail resolve independentemente da caixa (o índice do banco é sobre
`LOWER(email)`, então divergir aqui criaria endereço que cadastra e não loga); o
fallback por username sobrevive (é o que mantém o superusuário entrando); e conta
suspensa não autentica, que é onde a suspensão administrativa tem efeito.
"""
